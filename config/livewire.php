...
return [
    ...
    */
    ...
    | before they are validated and stored permanently. You can customize the
    | temporary upload rules, disk, directory, and max upload time below.
    |
    */

    'temporary_file_upload' => [
        'disk' => null,
        'rules' => ['file', 'max:524288'], // 512 MB (in KB)
        'directory' => null,
        'middleware' => null,
        'preview_mimes' => [
            'png', 'gif', 'bmp', 'svg', 'wav', 'mp4',
