...
>>>>>>> f41ff34d4a05c9f714f7c0c0a30c0717447e9f57
        ...
        <div class="flex items-center gap-2 md:hidden">
            <a href="{{ route('lang.switch', ['locale' => $otherLocale]) }}" class="px-2.5 py-1.5 rounded-lg text-xs font-sans font-bold text-slate-700 bg-slate-100 uppercase border border-slate-200" aria-label="Switch Language to {{ strtoupper($otherLocale) }}">
                {{ strtoupper($otherLocale) }}
            </a>
