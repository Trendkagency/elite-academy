    ...
    <div class="max-w-2xl w-full text-center space-y-8 relative z-10">
        ...
        <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 sm:p-14 border border-slate-200/90 shadow-2xl space-y-8 relative overflow-hidden">
            ...
            <div class="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="{{ $dashUrl }}" class="btn-lift w-full sm:w-auto px-6 py-3.5 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-extrabold rounded-2xl border border-slate-300 transition-all flex items-center justify-center gap-2">
                    <span>🏠</span> {{ $dashLabel }}
                </a>
            </div>
