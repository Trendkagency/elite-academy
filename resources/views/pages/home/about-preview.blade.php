...
<<<<<<< HEAD
                        <img src="{{ media_url(\App\Models\SiteSetting::get('about_image'), 'images/academy_campus.webp') }}" alt="Elite Academy Campus" class="w-full h-full object-cover">
=======
...
<<<<<<< HEAD
                            <img src="{{ media_url(\App\Models\SiteSetting::get('about_image'), 'images/academy_campus.webp') }}" alt="Elite Academy Campus Photography" class="w-full h-80 sm:h-[400px] lg:h-[440px] object-cover group-hover:scale-[1.03] transition-transform duration-700 ease-out">
=======
...
<<<<<<< HEAD
                        <img src="{{ asset('images/course_ai.webp') }}" alt="AI Neural Research" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
=======
...
<<<<<<< HEAD
                    <div class="hidden lg:block absolute top-1/3 -right-6 w-20 h-20 rounded-2xl overflow-hidden border-2 border-white shadow-xl z-30 animate-float group">
                        <img src="{{ asset('images/instructor_portrait.webp') }}" alt="Faculty Mentor Session" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
=======
