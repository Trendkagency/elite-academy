...
class EgyptianEduSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 8. Courses
        $cPhysics = Course::updateOrCreate(['slug' => 'physics-electricity-g12'], ['subject_id' => $subPhysics->id, 'teacher_id' => $tAhmed->id, 'grade_level_id' => $g12->id, 'title' => 'الفيزياء الكهربية والمغناطيسية والحديثة — الثالث الثانوي', 'description' => 'كورس متكامل يغطي قوانين كيرشوف والكهرومغناطيسية والفيزياء الحديثة النووية.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => true, 'is_accredited' => true, 'sessions_count' => 8, 'session_duration_minutes' => 60]);
        $cChem    = Course::updateOrCreate(['slug' => 'organic-chemistry-g12'],   ['subject_id' => $subChem->id,    'teacher_id' => $tSarah->id,  'grade_level_id' => $g12->id, 'title' => 'الكيمياء العضوية والتحليل الكيميائي — الثالث الثانوي',   'description' => 'هيدروكربونات، الألكانات والألكينات، المركبات الأروماتية.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => true, 'is_accredited' => true, 'sessions_count' => 7, 'session_duration_minutes' => 60]);
        $cBio     = Course::updateOrCreate(['slug' => 'biology-genetics-g12'],    ['subject_id' => $subBio->id,     'teacher_id' => $tFatma->id,  'grade_level_id' => $g12->id, 'title' => 'الأحياء وعلم الجينات والوراثة — الثالث الثانوي',           'description' => 'الخلية، DNA، قوانين مندل، الجهاز العصبي والبيئة.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => false, 'is_accredited' => true, 'sessions_count' => 6, 'session_duration_minutes' => 60]);
        $cMath    = Course::updateOrCreate(['slug' => 'calculus-algebra-g11'],    ['subject_id' => $subMath->id,    'teacher_id' => $tOmar->id,   'grade_level_id' => $g11->id, 'title' => 'التفاضل والتكامل والجبر والهندسة الفراغية — الثاني الثانوي', 'description' => 'النهايات، الاشتقاق، التكامل المحدود وغير المحدود.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => true, 'is_accredited' => true, 'sessions_count' => 8, 'session_duration_minutes' => 75]);
        $cProg    = Course::updateOrCreate(['slug' => 'python-ai-g10'],           ['subject_id' => $subProg->id,    'teacher_id' => $tKareem->id, 'grade_level_id' => $g10->id, 'title' => 'أساسيات البرمجة بـ Python والذكاء الاصطناعي — الأول الثانوي', 'description' => 'Python من الصفر: متغيرات، دوال، برمجة كائنية، وأول نموذج ذكاء اصطناعي.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => true, 'is_accredited' => false, 'sessions_count' => 6, 'session_duration_minutes' => 90]);
        $cEnglish = Course::updateOrCreate(['slug' => 'english-advanced-g11'],    ['subject_id' => $subEng->id,     'teacher_id' => $tHoda->id,   'grade_level_id' => $g11->id, 'title' => 'اللغة الإنجليزية المتقدمة — القواعد والبلاغة والأدب',       'description' => 'القواعد المتقدمة، النصوص الأدبية، التعبير الأكاديمي.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => false, 'is_accredited' => true, 'sessions_count' => 6, 'session_duration_minutes' => 60]);
        $cArabic  = Course::updateOrCreate(['slug' => 'arabic-grammar-g12'],      ['subject_id' => $subAr->id,      'teacher_id' => $tTarek->id,  'grade_level_id' => $g12->id, 'title' => 'اللغة العربية — النحو والصرف والبلاغة والأدب — الثالث الثانوي', 'description' => 'مراجعة شاملة للنحو والبلاغة والأدب مع نماذج الثانوية.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => true, 'is_accredited' => true, 'sessions_count' => 6, 'session_duration_minutes' => 60]);
        $cAI      = Course::updateOrCreate(['slug' => 'ai-robotics-g9'],          ['subject_id' => $subProg->id,    'teacher_id' => $tNouran->id, 'grade_level_id' => $g9->id,  'title' => 'مقدمة في الروبوتيك والذكاء الاصطناعي للناشئين',               'description' => 'الروبوتيك، Arduino، Scratch، ومقدمة Python للمرحلة الإعدادية.', 'demo_video_url' => 'https://digitability.com/wp-content/uploads/appropriate-sharing.mp4', 'is_active' => true, 'has_free_demo' => true, 'is_accredited' => false, 'sessions_count' => 5, 'session_duration_minutes' => 60]);
