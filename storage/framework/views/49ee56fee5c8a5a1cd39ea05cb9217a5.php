        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="space-y-2">
                ...
                <h1 class="font-heading text-3xl sm:text-4xl font-black text-white tracking-tight">
                    <?php echo e(app()->getLocale() === 'ar' ? 'حساب ولي الأمر: متابعة أبنائك الطلاب' : 'Parent Portal: Student Academic Dashboard'); ?>

                </h1>
                <p class="text-slate-300 text-sm font-mono">
                    <?php echo e(app()->getLocale() === 'ar' ? 'اختر أي ابن لمتابعة الحصص القادمة، الحضور والغياب، الواجبات، الباقة ورصيد الحصص المتبقي.' : "Monitor your linked children's upcoming sessions, attendance, homework, and remaining package credits."); ?>
            ...
            <div class="inline-flex items-center gap-2 bg-amber-500/20 px-4 py-2 rounded-2xl border border-amber-500/30 text-xs font-mono text-amber-300 font-bold self-start md:self-auto">
                <span>🔒</span>
                <span><?php echo e(app()->getLocale() === 'ar' ? 'وضع المتابعة للقراءة فقط (غير مسموح للتعديل)' : 'Strict Read-Only Parent Monitoring Mode'); ?></span>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="bg-white rounded-3xl p-8 border border-slate-200/90 shadow-xl space-y-6">
            <div class="flex items-center justify-between border-b border-slate-100 pb-4">
                <div>
                    <h2 class="font-heading font-black text-2xl text-slate-900"><?php echo e(app()->getLocale() === 'ar' ? 'الأبناء المربوطين بالحساب' : 'Your Linked Children'); ?></h2>
                    <p class="text-xs font-mono text-slate-500"><?php echo e(app()->getLocale() === 'ar' ? 'اضغط على بطاقة أي ابن لمتابعة أدائه ورصيده والتنبيهات بشكل مفصل.' : 'Select a child to inspect detailed academic performance, package & attendance.'); ?></p>
                </div>
                <span class="text-xs font-mono font-extrabold text-teal-700 bg-teal-50 px-3 py-1 rounded-full border border-teal-200">
                    <?php echo e(count($linkedStudents)); ?> <?php echo e(app()->getLocale() === 'ar' ? 'أبناء مربوطين' : 'Children Linked'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $linkedStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div id="child-card-<?php echo e($st->user_id); ?>" onclick="loadStudentProgress(<?php echo e($st->user_id); ?>)" class="child-card cursor-pointer bg-slate-50 hover:bg-teal-50/60 transition-all duration-300 rounded-2xl p-6 border-2 border-slate-200 hover:border-teal-500 shadow-sm space-y-4 group">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <span class="text-[11px] font-mono font-bold bg-teal-100 text-teal-800 px-2.5 py-0.5 rounded-md">
                                    <?php echo e($st->gradeLevel?->name ?: 'Grade Level'); ?>
                        ...
                        <div class="text-xs font-mono text-slate-500 space-y-1 pt-2 border-t border-slate-200/60">
                            <p class="truncate">🏫 <?php echo e($st->school_name ?: 'Elite STEM Academy'); ?></p>
                        ...
                        <button type="button" class="w-full py-2 bg-white group-hover:bg-teal-600 group-hover:text-white text-slate-800 rounded-xl text-xs font-bold font-mono border border-slate-200 transition-all shadow-xs">
                            <?php echo e(app()->getLocale() === 'ar' ? 'عرض تقرير الطالب الشامل ←' : 'Inspect Child Dashboard &rarr;'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\elite-academy\resources\views/pages/parent-portal.blade.php ENDPATH**/ ?>