...
<style>
    ...
    html, body, button, input, select, textarea, table, th, td, label, .fi-body, .fi-panel, .fi-modal, .fi-dropdown, .fi-input, .fi-btn, .fi-sidebar, .fi-header, .fi-badge, .fi-avatar, .fi-breadcrumbs, .fi-section, .fi-widget, .fi-table {
        font-family: 'Cairo', sans-serif !important;
    }
</style>
