    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[90px] lg:h-[100px] flex items-center justify-between gap-2 lg:gap-4">
        ...
        <div class="hidden md:flex items-center space-x-1.5 lg:space-x-2.5 rtl:space-x-reverse text-xs font-bold font-sans shrink-0">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="btn-lift px-3.5 py-2 rounded-xl text-slate-800 hover:bg-slate-100 border border-slate-200/90 transition-all font-sans font-bold text-xs whitespace-nowrap shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                ...
                <form action="<?php echo e(route('logout')); ?>" method="POST" class="inline shrink-0">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="px-2.5 py-2 rounded-xl text-slate-600 hover:text-red-600 hover:bg-red-50 transition-colors font-sans font-bold text-xs whitespace-nowrap shrink-0 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600">
        ...
        <div class="flex items-center gap-2 md:hidden">
            <a href="<?php echo e(route('lang.switch', ['locale' => $otherLocale])); ?>" class="px-2.5 py-1.5 rounded-lg text-xs font-sans font-bold text-slate-700 bg-slate-100 uppercase border border-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" aria-label="Switch Language to <?php echo e(strtoupper($otherLocale)); ?>">
                <?php echo e(strtoupper($otherLocale)); ?>
