    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <div class="space-y-3 max-w-3xl">
            ...
            <div class="flex flex-wrap items-center gap-6 pt-4 text-xs font-medium text-slate-300">
                ...
                <span><i class="fa-solid fa-users"></i> Teacher: <?php echo e($cTeacher); ?></span>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-2xs space-y-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEnrolled ?? false): ?>
                            <a href="<?php echo e(route('student-portal')); ?>" class="btn-lift w-full inline-block text-center py-3.5 px-6 font-semibold text-white bg-teal-600 hover:bg-teal-700 rounded-xl shadow-md transition-all">
                                <?php echo e(app()->getLocale() === 'ar' ? 'مشترك في هذا الكورس <i class="fa-solid fa-check"></i> — الذهاب لبوابة الطالب ←' : 'Enrolled Course <i class="fa-solid fa-check"></i> — Go to Student Portal &rarr;'); ?>
                        ...
                        <?php else: ?>
                            <button id="btnEnroll" class="w-full text-center py-3.5 px-6 font-semibold text-white bg-orange-500 hover:bg-orange-600 rounded-xl shadow-md transition-all cursor-pointer">
                                <?php echo e(app()->getLocale() === 'ar' ? 'التسجيل في الكورس الآن <i class="fa-solid fa-rocket"></i>' : 'Enroll in Course Now <i class="fa-solid fa-rocket"></i>'); ?>
                    ...
                    <div class="pt-4 border-t border-slate-100 space-y-3">
                        ...
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('images/instructor_portrait.webp')); ?>" alt="<?php echo e($cTeacher); ?>" class="w-10 h-10 rounded-xl object-cover border border-teal-500">
                            <div>
    ...
    btn.addEventListener('click', async function () {
        ...
        try {
            ...
            if (data.success) {
                ...
                const linkText = "<?php echo e(app()->getLocale() === 'ar' ? 'تم التسجيل بنجاح <i class="fa-solid fa-check"></i> — الذهاب لبوابة الطالب ←' : 'Enrolled Successfully <i class="fa-solid fa-check"></i> — Go to Student Portal &rarr;'); ?>";
                ...
                btn.disabled = false;
                btn.textContent = "<?php echo e(app()->getLocale() === 'ar' ? 'التسجيل في الكورس الآن <i class="fa-solid fa-rocket"></i>' : 'Enroll in Course Now <i class="fa-solid fa-rocket"></i>'); ?>";
            }
        } catch (e) {
            btn.disabled = false;
            btn.textContent = "<?php echo e(app()->getLocale() === 'ar' ? 'التسجيل في الكورس الآن <i class="fa-solid fa-rocket"></i>' : 'Enroll in Course Now <i class="fa-solid fa-rocket"></i>'); ?>";
