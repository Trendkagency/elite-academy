    ...
    <div class="overview-grid">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePackage): ?>
                ...
                <div style="background: #0f172a; padding: 14px; border-radius: 14px; border: 1px solid #1e293b;">
                    <div style="display: flex; justify-content: space-between; font-size: 13px; font-weight: 800; color: #ffffff;">
                        <span><?php echo e($activePackage->packageTemplate?->name ?? 'Custom Package'); ?></span>
                        <span style="color: #2dd4bf;"><?php echo e($rem); ?> / <?php echo e($tot); ?> Sessions Remaining</span>
                    </div>
                    <div class="pkg-progress-bar-bg">
                        <div class="pkg-progress-bar-fill" style="width: <?php echo e($pct); ?>%;"></div>
                    </div>
                    <div style="display: flex; justify-content: space-between; font-size: 10px; font-weight: 700; color: #94a3b8; margin-top: 8px;">
                        <span>Activated: <?php echo e($activePackage->activated_at ? $activePackage->activated_at->format('d M Y') : 'N/A'); ?></span>
                        <span>Expires: <?php echo e($activePackage->expires_at ? $activePackage->expires_at->format('d M Y') : 'No Expiry'); ?></span>
                    </div>
                </div>
            <?php else: ?>
                <div class="empty-box">
        ...
        <div class="overview-card">
            <div class="card-title-bar">
                ...
                <span class="card-badge badge-teal"><?php echo e($parents->count()); ?> Linked</span>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($parents->isNotEmpty()): ?>
                <div class="item-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <div class="list-row">
                            <div>
                                <div class="list-row-title"><i class="fa-solid fa-people-roof"></i> <?php echo e($parentUser?->name ?? 'Unknown Parent'); ?></div>
                                <div class="list-row-sub"><i class="fa-solid fa-envelope"></i> <?php echo e($parentUser?->email ?? 'N/A'); ?> | <i class="fa-solid fa-mobile-screen"></i> <?php echo e($parentUser?->phone ?? 'N/A'); ?></div>
                            </div>
                            <a href="<?php echo e(route('filament.admin.resources.parent-profiles.edit', ['record' => $parent->id])); ?>" target="_blank" style="font-size: 11px; font-weight: 800; color: #38bdf8; text-decoration: none;">
                                View ↗
                            </a>
                        </div>
        ...
        <div class="overview-card">
            <div class="card-title-bar">
                ...
                <span class="card-badge badge-teal"><?php echo e($enrollments->count()); ?> Courses</span>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->isNotEmpty()): ?>
                <div class="item-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <div class="list-row">
                            <div>
                                <div class="list-row-title"><i class="fa-solid fa-book"></i> <?php echo e($enrollment->course?->title ?? 'Course'); ?></div>
                                <div class="list-row-sub">Status: <?php echo e(ucfirst($eStatus)); ?> | Date: <?php echo e($enrollment->created_at->format('d M Y')); ?></div>
                            </div>
        ...
        <div class="overview-card">
            <div class="card-title-bar">
                ...
                <span class="card-badge badge-teal"><?php echo e($submissions->count()); ?> Submissions</span>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submissions->isNotEmpty()): ?>
                <div class="item-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <div class="list-row">
                            <div>
                                <div class="list-row-title"><i class="fa-solid fa-pen-to-square"></i> <?php echo e($sub->assignment?->title ?? 'Assignment'); ?></div>
                                <div class="list-row-sub">Score: <?php echo e($sub->grade ?? 'Pending Review'); ?>% | Submitted: <?php echo e($sub->submitted_at ? $sub->submitted_at->format('d M Y') : 'N/A'); ?></div>
                            </div>
                            <span style="font-size: 11px; font-weight: 800; color: #fbbf24;"><?php echo e(ucfirst($sStatus)); ?></span>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            <?php else: ?>
...
<?php /**PATH C:\laragon\www\elite-academy\resources\views/filament/resources/student-profile/academic-overview.blade.php ENDPATH**/ ?>