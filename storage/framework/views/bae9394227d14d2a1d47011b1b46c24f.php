        ...
        <div class="xl:col-span-7 space-y-4">
            ...
            <div class="p-4 bg-slate-200/60 dark:bg-slate-800/60 rounded-2xl border border-slate-300 dark:border-slate-700 shadow-inner flex justify-center items-center overflow-hidden min-h-[750px]">
                <div :class="{
                    ...
                    <iframe id="contact-preview-iframe" src="<?php echo e(url('/contact?iframe=1')); ?>" title="Contact Page UI Preview" class="w-full h-full border-0 block"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\elite-academy\resources\views/filament/pages/manage-contact-page.blade.php ENDPATH**/ ?>