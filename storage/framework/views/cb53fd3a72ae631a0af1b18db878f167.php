    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 pb-2 border-b border-slate-800/80">
            ...
            <div class="flex items-center gap-4 shrink-0">
                <a href="<?php echo e(route('teachers')); ?>" class="text-xs font-mono font-bold text-teal-400 hover:text-teal-300 transition-colors hidden sm:inline">
                    <?php echo e($isAr ? '← تصفح كافة المعلمين' : 'Browse All Faculty →'); ?>
        ...
        <div id="teachersSwiperTrack" class="flex items-center gap-6 overflow-x-auto py-4 snap-x snap-mandatory scroll-smooth no-scrollbar select-none cursor-grab active:cursor-grabbing" style="scrollbar-width: none; -ms-overflow-style: none;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mentors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div class="teacher-slide-card w-[300px] sm:w-[380px] lg:w-[420px] shrink-0 h-[440px] rounded-3xl overflow-hidden shadow-2xl border border-slate-800/90 relative group card-lift transition-all duration-500 snap-center bg-slate-900" data-slide-index="<?php echo e($index); ?>">
                    ...
                    <span class="absolute top-5 left-5 text-xs font-mono font-extrabold text-white <?php echo e($m['badgeBg']); ?> px-3.5 py-1.5 rounded-full shadow-lg z-10 border border-white/20">
                        <?php echo e($m['dept']); ?>
                    ...
                    <div class="absolute bottom-6 left-6 right-6 text-white space-y-3 z-10">
                        <div>
                            <h3 class="font-heading font-black text-2xl text-white <?php echo e($m['textColor']); ?> transition-colors line-clamp-1">
                                <?php echo e($m['name']); ?>

                            </h3>
                            <p class="text-xs font-mono text-slate-300 font-semibold mt-0.5 line-clamp-1"><?php echo e($m['title']); ?></p>
                        </div>

                        <div class="flex items-center justify-between pt-3 border-t border-white/15 text-xs font-medium text-slate-300">
                            <span class="text-[11px] font-mono text-slate-400"><?php echo e($m['meta']); ?></span>
                            <a href="<?php echo e($profileUrl); ?>" class="btn-lift px-3.5 py-1.5 bg-teal-500/20 hover:bg-teal-500 text-teal-300 hover:text-slate-950 font-extrabold rounded-xl border border-teal-500/40 hover:border-teal-400 text-xs flex items-center gap-1.5 transition-all shadow-md" aria-label="View faculty profile for <?php echo e($m['name']); ?>">
        ...
        <div id="teachersSwiperDots" class="flex items-center justify-center gap-2 pt-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mentors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <button type="button" onclick="scrollTeachersToSlide(<?php echo e($index); ?>)" class="teacher-dot h-2.5 rounded-full transition-all duration-300 cursor-pointer <?php echo e($index === 0 ? 'bg-teal-400 w-8' : 'bg-slate-700 hover:bg-slate-500 w-2.5'); ?>" aria-label="Go to teacher slide <?php echo e($index + 1); ?>"></button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
