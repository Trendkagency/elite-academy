...
<div class="linked-children-container"
    ...
    <?php else: ?>
        <div class="child-card-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                <div class="child-card"
                     x-show="<?php echo e($index); ?> >= (page - 1) * perPage && <?php echo e($index); ?> < page * perPage"
                    ...
                    <div>
                        ...
                        <div class="child-header">
                            <a href="<?php echo e($studentProfileUrl); ?>" target="_blank" class="child-info" title="انقر لعرض وإدارة ملف الطالب بالكامل">
                                <div class="child-avatar">🎓</div>
                                <div>
                                    <h4 class="child-name">
                                        <?php echo e($child->name); ?> ↗
                                    </h4>
                                    <span class="child-id-tag">ID: #<?php echo e($child->id); ?></span>
                                </div>
                            </a>
                        ...
                        <div class="quick-stats-row">
                            <div class="stat-chip">
                                <div class="stat-chip-num"><?php echo e($enrollmentsCount); ?></div>
                                <div class="stat-chip-lbl">الكورسات (Courses)</div>
                            </div>
                            <div class="stat-chip">
                                <div class="stat-chip-num"><?php echo e($submissionsCount); ?></div>
                                <div class="stat-chip-lbl">الواجبات (Homework)</div>
                            </div>
                            <div class="stat-chip">
                                <div class="stat-chip-num"><?php echo e($exceptionsCount); ?></div>
                        ...
                        <div class="detail-grid">
                            <div class="detail-item">
                                ...
                                <span class="detail-value" title="<?php echo e($child->email); ?>">📧 <?php echo e($child->email); ?></span>
                            </div>

                            <div class="detail-item">
                                <span class="detail-label">الهاتف / Phone</span>
                                <span class="detail-value" title="<?php echo e($phoneStr); ?>">📱 <?php echo e($phoneStr); ?></span>
                            </div>

                            <div class="detail-item">
                                <span class="detail-label">الصف / Grade</span>
                                <span class="detail-value detail-value-teal" title="<?php echo e($gradeName); ?>">🏫 <?php echo e($gradeName); ?></span>
                            </div>

                            <div class="detail-item">
                                <span class="detail-label">المدرسة / School</span>
                                <span class="detail-value" title="<?php echo e($schoolName); ?>">🏢 <?php echo e($schoolName); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="progress-footer">
                            <div class="progress-header">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePkg): ?>
                                    <span class="progress-pill"><?php echo e($remaining); ?> / <?php echo e($total); ?> Sessions</span>
                                <?php else: ?>
                                    <span class="progress-pill-none">لا توجد باقة نشطة</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePkg && $total > 0): ?>
                        ...
                        <div class="card-actions-row">
                            <a href="<?php echo e($studentProfileUrl); ?>" target="_blank" class="action-btn-primary" title="الانتقال لبروفايل الطالب وإدارته بالكامل">
                                ⚡ <span>إدارة الطالب (Manage Student)</span>
                            </a>
                            <a href="<?php echo e($userEditUrl); ?>" target="_blank" class="action-btn-secondary" title="إدارة حساب المستخدم والصلاحيات">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalCount > 2): ?>
            <div class="pagination-toolbar">
                ...
                <div class="flex items-center gap-3">
                    <span class="pagination-info">
                        صفحة <strong x-text="page" class="text-teal-400"></strong> من <strong x-text="totalPages" class="text-teal-400"></strong> (إجمالي <span class="text-white font-extrabold"><?php echo e($totalCount); ?></span> أبناء)
                    </span>
...
<?php /**PATH C:\laragon\www\elite-academy\resources\views\filament\resources\parent-profile\children-details.blade.php ENDPATH**/ ?>