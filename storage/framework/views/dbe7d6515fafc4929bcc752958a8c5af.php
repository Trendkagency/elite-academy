    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between px-2">
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('student-portal')); ?>" class="font-heading font-black text-2xl sm:text-3xl text-slate-900 tracking-tight hover:opacity-80 transition-opacity flex items-center gap-2">
            ...
            <div class="flex items-center gap-3 bg-white px-4 py-2 rounded-2xl border border-slate-200 shadow-xs">
                ...
                <div class="text-left text-xs leading-tight">
                    <h4 class="font-extrabold text-slate-900"><?php echo e(auth()->user()->name ?? 'Learner'); ?></h4>
                    <span class="font-mono text-slate-500 text-[11px] block">ID: <?php echo e(auth()->user()->id ?? '1001'); ?></span>
                </div>
            </div>
        </div>

        
        <form id="eliteQuizForm" action="<?php echo e(route('ajax.assignment.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="quiz-main-card p-6 sm:p-10 md:p-12 relative overflow-hidden space-y-8">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span id="quizTimer" class="font-mono font-black text-slate-900 text-base sm:text-lg">
                                <?php echo e(sprintf('%02d : %02d : %02d', $dispHrs, $dispMins, $dispSecs)); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[320px]">
                    ...
                    <div class="lg:col-span-8 space-y-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $assignment->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div id="questionStep<?php echo e($index); ?>" class="question-step space-y-6 <?php echo e($index === 0 ? '' : 'hidden'); ?>" data-step="<?php echo e($index); ?>">
                                
                                
                                <div class="space-y-1">
                                    <span class="text-xs font-mono font-extrabold text-slate-500 block">
                                        Question <span class="text-teal-700"><?php echo e($index + 1); ?></span> of <?php echo e(count($assignment->questions)); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($q->image_path): ?>
                                        <div class="rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 p-3 max-w-lg my-3 shadow-xs">
                                            <img src="<?php echo e(asset('storage/' . $q->image_path)); ?>" class="max-h-56 rounded-xl object-contain pointer-events-none">
                                        </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $q->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optIndex => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php
                                        ...
                                        ?>
                                        <label class="option-label option-card-elite p-4 sm:p-5 flex items-center justify-between cursor-pointer text-sm font-semibold text-slate-800 shadow-xs <?php echo e($isChecked ? 'selected' : ''); ?>">
                                            <div class="flex items-center gap-3">
                                                <input type="<?php echo e($inputType); ?>" name="answers[<?php echo e($q->id); ?>][]" value="<?php echo e($opt->id); ?>" <?php echo e($isChecked ? 'checked' : ''); ?> class="option-input accent-teal-600 w-4 h-4 cursor-pointer">
                                                
                                                <span class="option-letter-badge font-mono font-bold text-slate-400 w-6">
                                                    <?php echo e($letter); ?>.
                                                </span>

                                                <span class="math-render leading-relaxed text-sm sm:text-base font-bold text-slate-800"><?php echo e($opt->option_text); ?></span>
                                            </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($opt->image_path): ?>
                                                <img src="<?php echo e(asset('storage/' . $opt->image_path)); ?>" class="h-8 rounded border border-slate-200 pointer-events-none">
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </label>
                    ...
                    <div class="lg:col-span-4 flex flex-col items-center justify-center p-4">
                        <div class="relative w-44 h-44 flex items-center justify-center">
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                                <span id="gaugeText" class="font-heading font-black text-3xl sm:text-4xl text-slate-900 tracking-tight">1/<?php echo e(count($assignment->questions)); ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-slate-100">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-2 overflow-x-auto py-1" id="dotsContainer">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $assignment->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <button type="button" data-step-index="<?php echo e($i); ?>" class="dot-item btn-elite-nav w-10 h-10 text-xs font-bold font-mono flex items-center justify-center <?php echo e($i === 0 ? 'active-step' : ''); ?>">
                                <?php echo e($i + 1); ?>
...
<div id="resultModal" class="hidden fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl space-y-6 border border-slate-200 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <a href="<?php echo e(route('student-portal')); ?>" class="w-full sm:w-auto btn-elite-primary px-8 py-3 font-bold text-xs shadow-md">
...
<script>
window.currentStep = <?php echo e($currentStepIndex ?? 0); ?>;
window.totalSteps = <?php echo e(count($assignment->questions)); ?>;
window.durationMinutes = <?php echo e($assignment->duration_minutes ?? 30); ?>;
window.serverRemainingSeconds = <?php echo e($remainingSeconds ?? 1800); ?>;
window.examDeadline = Date.now() + (window.serverRemainingSeconds * 1000);
window.timerSeconds = window.serverRemainingSeconds;
window.assignmentId = <?php echo e($assignment->id); ?>;
window.savedAnswers = <?php echo json_encode($savedAnswers ?? [], 15, 512) ?>;
...
window.persistStepIndexToServer = async function(stepIdx) {
    try {
        await fetch("<?php echo e(route('ajax.assignment.update-step')); ?>", {
            method: 'POST',
            headers: {
        ...
        if (!window.isStepAnswered(window.currentStep)) {
            if (window.Toast) {
                window.Toast.warning(
                    "<?php echo e(app()->getLocale() === 'ar' ? '<i class="fa-solid fa-triangle-exclamation"></i> يرجى اختيار إجابة للسؤال الحالي أولاً قبل الانتقال للسؤال التالي.' : '<i class="fa-solid fa-triangle-exclamation"></i> Please select an answer for the current question before advancing.'); ?>",
                    "<?php echo e(app()->getLocale() === 'ar' ? 'إجابة السؤال مطلوبة' : 'Answer Required'); ?>"
                );
            }
            return false;
        }
    ...
    if (targetStepIdx > window.currentStep) {
        for (let i = 0; i < targetStepIdx; i++) {
            if (!window.isStepAnswered(i)) {
                if (window.Toast) {
                    window.Toast.warning(
                        `<?php echo e(app()->getLocale() === 'ar' ? '<i class="fa-solid fa-triangle-exclamation"></i> يرجى إجابة السؤال رقم (' : '<i class="fa-solid fa-triangle-exclamation"></i> Please answer question #'); ?>${i + 1}<?php echo e(app()->getLocale() === 'ar' ? ') أولاً قبل الانتقال لأسئلة لاحقة.' : ' first before skipping ahead.'); ?>`,
                        "<?php echo e(app()->getLocale() === 'ar' ? 'إجابة السؤال مطلوبة' : 'Answer Required'); ?>"
                    );
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleQuizTimeExpired() {
        ...
        if (window.Toast) {
            window.Toast.error(
                "<?php echo e(app()->getLocale() === 'ar' ? '<i class="fa-solid fa-triangle-exclamation"></i> انتهى الوقت المحدد للواجب! يتم الآن إرسال إجاباتك وتقييمها تلقائياً...' : '<i class="fa-solid fa-triangle-exclamation"></i> Time is up! Submitting and evaluating your answers automatically...'); ?>",
                "<?php echo e(app()->getLocale() === 'ar' ? 'انتهى الوقت' : 'Time Expired'); ?>"
            );
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\elite-academy\resources\views/pages/student-assignment-take.blade.php ENDPATH**/ ?>