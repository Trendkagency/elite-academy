        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-6 relative">
                <div class="rounded-3xl overflow-hidden shadow-2xl border-4 border-white h-[420px] bg-slate-950">
                    <img src="<?php echo e(media_url($heroImage, 'images/academy_campus.png')); ?>" alt="Campus Support Desk" class="w-full h-full object-cover">
                </div>
                <div class="absolute -bottom-6 -left-6 bg-teal-600 text-white p-5 rounded-2xl shadow-2xl flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-heading font-black text-lg"><?php echo e($cardTitle); ?></p>
                        <p class="text-xs font-mono text-teal-100"><?php echo e($cardSubtitle); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-20 md:py-28 bg-[#FAFAF9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/90 shadow-xl space-y-6">
            <div class="space-y-2">
                <h2 class="font-heading text-2xl sm:text-3xl font-black text-slate-900"><?php echo e($formTitle); ?></h2>
                <p class="text-xs font-mono text-slate-500"><?php echo e($formSubtitle); ?></p>
            </div>
