...
>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dbHeroSlides->count() > 0): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dbHeroSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div 
                data-slide-index="<?php echo e($idx); ?>"
                class="hero-slide absolute inset-0 <?php echo e($idx === 0 ? 'opacity-100 z-10 block' : 'opacity-0 z-0 hidden pointer-events-none'); ?> transition-opacity duration-700 ease-out flex flex-col justify-between"
            >
<<<<<<< HEAD
                <img src="<?php echo e(media_url($s->image, 'images/hero_student.webp')); ?>" alt="<?php echo e($s->title); ?>" width="1920" height="1080" <?php echo e($idx === 0 ? 'fetchpriority="high" loading="eager"' : 'loading="lazy" decoding="async"'); ?> class="absolute inset-0 w-full h-full object-cover animate-ken-burns">
=======
                <img src="<?php echo e(media_url($s->image, 'images/hero_student.webp')); ?>" alt="<?php echo e($s->title); ?>" width="1920" height="1080" class="absolute inset-0 w-full h-full object-cover" <?php echo e($idx === 0 ? 'fetchpriority="high" loading="eager"' : 'loading="lazy" decoding="async"'); ?>>
>>>>>>> f41ff34d4a05c9f714f7c0c0a30c0717447e9f57
                    ...
                    <div class="lg:col-span-8 space-y-4 sm:space-y-6 max-w-xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-3.5 pt-2 w-full max-w-md lg:max-w-none">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s->cta_primary_url): ?>
                                <a href="<?php echo e($s->cta_primary_url); ?>" class="btn-mobile-lg btn-lift group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 text-slate-950 bg-gradient-to-r from-teal-400 to-teal-500 hover:from-teal-300 hover:to-teal-400 shadow-lg shadow-teal-500/25" aria-label="Explore <?php echo e($s->getLocalizedTitle()); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s->cta_secondary_url): ?>
                                <a href="<?php echo e($s->cta_secondary_url); ?>" class="btn-mobile-lg btn-lift w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 text-white bg-white/12 hover:bg-white/20 border border-white/30 backdrop-blur-md shadow-md shadow-white/10" aria-label="Learn more about <?php echo e($s->getLocalizedTitle()); ?>">
    ...
    <?php else: ?>
        ...
        >
<<<<<<< HEAD
            <img src="<?php echo e(asset('images/hero_student.webp')); ?>" alt="Programming & Tech Lab" width="1920" height="1080" fetchpriority="high" loading="eager" class="absolute inset-0 w-full h-full object-cover animate-ken-burns">
=======
            <img src="<?php echo e(asset('images/hero_student.webp')); ?>" alt="Programming & Tech Lab" width="1920" height="1080" class="absolute inset-0 w-full h-full object-cover" fetchpriority="high" loading="eager">
>>>>>>> f41ff34d4a05c9f714f7c0c0a30c0717447e9f57
            <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/50 to-slate-950/30"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto py-10 lg:py-20 relative z-20 flex flex-col lg:grid lg:grid-cols-12 gap-6 items-center text-center lg:text-left">
                <div class="lg:col-span-8 space-y-4 sm:space-y-6 max-w-xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3.5 pt-2 w-full max-w-md lg:max-w-none">
                        <a href="<?php echo e(SiteSetting::get('landing_cta_primary_link', '/subjects')); ?>" class="btn-mobile-lg btn-lift group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 text-slate-950 bg-gradient-to-r from-teal-400 to-teal-500 hover:from-teal-300 hover:to-teal-400 shadow-lg shadow-teal-500/25" aria-label="Explore all academic subjects">
                            <span><?php echo e(SiteSetting::getLocalized('landing_cta_primary_text', 'Explore All Subjects')); ?></span>
                            <span class="group-hover:translate-x-1.5 transition-transform duration-300">&rarr;</span>
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-mobile-lg btn-lift w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 text-white bg-white/12 hover:bg-white/20 border border-white/30 backdrop-blur-md shadow-md shadow-white/10" aria-label="Book a free academic trial session">
        ...
        >
<<<<<<< HEAD
            <img src="<?php echo e(asset('images/course_ai.webp')); ?>" alt="AI Neural Networks Lab" width="1920" height="1080" loading="lazy" decoding="async" class="absolute inset-0 w-full h-full object-cover animate-ken-burns">
=======
            <img src="<?php echo e(asset('images/course_ai.webp')); ?>" alt="AI Neural Networks Lab" width="1920" height="1080" class="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async">
>>>>>>> f41ff34d4a05c9f714f7c0c0a30c0717447e9f57
            <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/50 to-slate-950/30"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto py-10 lg:py-20 relative z-20 flex flex-col lg:grid lg:grid-cols-12 gap-6 items-center text-center lg:text-left">
                <div class="lg:col-span-8 space-y-4 sm:space-y-6 max-w-xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3.5 pt-2 w-full max-w-md lg:max-w-none">
                        <a href="<?php echo e(route('subject-details')); ?>" class="btn-mobile-lg btn-lift group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 text-white bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 shadow-lg shadow-purple-600/25" aria-label="Explore AI Subject Curriculum">
                            <span><?php echo e(__('Explore AI')); ?></span>
                            <span class="group-hover:translate-x-1.5 transition-transform duration-300">&rarr;</span>
                        </a>
                        <a href="<?php echo e(route('courses')); ?>" class="btn-mobile-lg btn-lift w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 text-white bg-white/12 hover:bg-white/20 border border-white/30 backdrop-blur-md shadow-md shadow-white/10" aria-label="View Full Course Curriculum">
        ...
        >
<<<<<<< HEAD
            <img src="<?php echo e(asset('images/instructor_male.webp')); ?>" alt="Robotics Engineering Lab" width="1920" height="1080" loading="lazy" decoding="async" class="absolute inset-0 w-full h-full object-cover">
=======
            <img src="<?php echo e(asset('images/instructor_male.webp')); ?>" alt="Robotics Engineering Lab" width="1920" height="1080" class="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async">
>>>>>>> f41ff34d4a05c9f714f7c0c0a30c0717447e9f57
            <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/50 to-slate-950/30"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto py-10 lg:py-20 relative z-20 flex flex-col lg:grid lg:grid-cols-12 gap-6 items-center text-center lg:text-left">
                <div class="lg:col-span-8 space-y-4 sm:space-y-6 max-w-xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3.5 pt-2 w-full max-w-md lg:max-w-none">
                        <a href="<?php echo e(route('subjects')); ?>" class="btn-mobile-lg btn-lift group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 text-white bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-400 shadow-lg shadow-orange-500/25" aria-label="Explore Robotics Track">
                            <span><?php echo e(__('Explore Robotics')); ?></span>
                            <span class="group-hover:translate-x-1.5 transition-transform duration-300">&rarr;</span>
                        </a>
                        <a href="<?php echo e(route('event-details')); ?>" class="btn-mobile-lg btn-lift w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 text-white bg-white/12 hover:bg-white/20 border border-white/30 backdrop-blur-md shadow-md shadow-white/10" aria-label="Join Robotics Engineering Workshop">
        ...
        >
<<<<<<< HEAD
            <img src="<?php echo e(asset('images/academy_campus.webp')); ?>" alt="Science Laboratory" width="1920" height="1080" loading="lazy" decoding="async" class="absolute inset-0 w-full h-full object-cover">
=======
            <img src="<?php echo e(asset('images/academy_campus.webp')); ?>" alt="Science Laboratory" width="1920" height="1080" class="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async">
>>>>>>> f41ff34d4a05c9f714f7c0c0a30c0717447e9f57
            <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/50 to-slate-950/30"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto py-10 lg:py-20 relative z-20 flex flex-col lg:grid lg:grid-cols-12 gap-6 items-center text-center lg:text-left">
                <div class="lg:col-span-8 space-y-4 sm:space-y-6 max-w-xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3.5 pt-2 w-full max-w-md lg:max-w-none">
                        <a href="<?php echo e(route('subjects')); ?>" class="btn-mobile-lg btn-lift group w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 text-slate-950 bg-gradient-to-r from-teal-400 to-teal-500 hover:from-teal-300 shadow-lg shadow-teal-500/25" aria-label="Explore Science & Math">
                            <span><?php echo e(__('Explore Science')); ?></span>
                            <span class="group-hover:translate-x-1.5 transition-transform duration-300">&rarr;</span>
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-mobile-lg btn-lift w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 text-white bg-white/12 hover:bg-white/20 border border-white/30 backdrop-blur-md shadow-md shadow-white/10" aria-label="Book a free science trial session">
    ...
    <div class="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-8 flex items-center justify-between border-t border-white/15 pt-6">
        <div class="font-mono text-sm font-bold text-slate-200 flex items-center gap-4">
            ...
            <div class="w-32 sm:w-48 h-1.5 bg-white/20 rounded-full relative overflow-hidden">
                <div id="hero-progress-bar" class="absolute top-0 bottom-0 left-0 bg-teal-400 rounded-full transition-all duration-500" style="width: <?php echo e(round((1 / $totalSlideCount) * 100)); ?>%"></div>
            </div>
            <span class="text-slate-400 text-sm"><?php echo e(str_pad($totalSlideCount, 2, '0', STR_PAD_LEFT)); ?></span>
        </div>

        <div class="flex items-center gap-4">
            <div id="hero-dots-container" class="hidden sm:flex items-center gap-2.5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < $totalSlideCount; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <button 
                        type="button" 
                        onclick="window.heroSlider && window.heroSlider.goTo(<?php echo e($i); ?>)" 
                        class="hero-dot h-3 rounded-full transition-all duration-300 cursor-pointer <?php echo e($i === 0 ? 'bg-teal-400 w-7' : 'bg-white/30 w-3 hover:bg-white/70'); ?>" 
                        aria-label="Go to slide <?php echo e($i + 1); ?>"
                    ></button>
