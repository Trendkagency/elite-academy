    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div class="text-center space-y-4 max-w-3xl mx-auto">
            <span class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-mono font-bold bg-teal-950/80 text-teal-300 border border-teal-500/40">
                <span><i class="fa-solid fa-comments"></i></span> <?php echo e($isAr ? 'مركز الأسئلة الشائعة والمعلومات' : 'Frequently Asked Questions'); ?>
        ...
        <div class="space-y-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $homeFaqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <div class="bg-gradient-to-r from-slate-900 via-slate-800 to-teal-950 rounded-3xl p-8 text-white flex flex-wrap items-center justify-between gap-6 shadow-xl border border-slate-700/80">
            <div class="space-y-1 max-w-xl">
                <h3 class="font-heading font-bold text-lg text-white">
                    <?php echo e($isAr ? 'لديك استفسار آخر لم نجب عليه؟' : 'Have a specific question not listed here?'); ?>

                </h3>
                <p class="text-xs text-slate-300">
                    <?php echo e($isAr ? 'فريق الدعم الأكاديمي والتقني متاح على مدار الساعة للإجابة على جميع تساؤلاتك.' : 'Our academic support specialists are available 24/7 to guide you.'); ?>

                </p>
            </div>
            <a href="<?php echo e(route('contact')); ?>" class="btn-lift px-6 py-3 bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold rounded-2xl text-xs shadow-lg transition-all">
                <i class="fa-solid fa-comments"></i> <?php echo e($isAr ? 'تواصل مع الدعم المباشر' : 'Contact Support Team'); ?>

            </a>
        </div>
    </div>
</section>
<?php /**PATH C:\laragon\www\elite-academy\resources\views/pages/home/faq-section.blade.php ENDPATH**/ ?>