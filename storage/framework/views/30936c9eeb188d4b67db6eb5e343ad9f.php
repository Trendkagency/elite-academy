        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div class="lg:col-span-8 space-y-12">
                ...
                <div class="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-2xs space-y-4">
                    ...
                    <div class="flex items-center gap-4 pt-2">
                        <img src="<?php echo e(asset('images/instructor_male.png')); ?>" alt="Marcus Vance" class="w-16 h-16 rounded-2xl object-cover border-2 border-purple-500">
                        <div>
            ...
            <div class="lg:col-span-4 space-y-6">
                <div id="register" class="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-lg sticky top-24 space-y-6">
                    ...
                    <form action="<?php echo e(route('events')); ?>" method="GET" class="space-y-4 text-xs">
                        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\elite-academy\resources\views\pages\event-details.blade.php ENDPATH**/ ?>