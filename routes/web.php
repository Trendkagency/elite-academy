...
Route::middleware(SetLocale::class)->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware([\App\Http\Middleware\EnsureTeacherRole::class])->group(function () {
            ...
            Route::post('/ajax/teacher/recurring-schedules/{id}/update', [\App\Http\Controllers\Teacher\TeacherPortalController::class, 'updateRecurringSchedule'])->middleware('throttle:strict_actions')->name('ajax.teacher.recurring.update');
            Route::match(['post', 'delete'], '/ajax/teacher/recurring-schedules/{id}/delete', [\App\Http\Controllers\Teacher\TeacherPortalController::class, 'deleteRecurringSchedule'])->middleware('throttle:strict_actions')->name('ajax.teacher.recurring.delete');
            ...
            Route::match(['post', 'delete'], '/ajax/teacher/sessions/{id}/delete', [\App\Http\Controllers\Teacher\TeacherPortalController::class, 'deleteSession'])->middleware('throttle:strict_actions')->name('ajax.teacher.sessions.delete');
            ...
            Route::post('/ajax/teacher/assignments/{id}/update', [\App\Http\Controllers\Teacher\TeacherPortalController::class, 'updateAssignment'])->middleware('throttle:strict_actions')->name('ajax.teacher.assignments.update');
